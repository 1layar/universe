...
import (
	...
	"github.com/1layar/merasa/backend/src/product_catalog_service/internal/app/appconfig"
	"github.com/1layar/merasa/backend/src/product_catalog_service/internal/app/appcontext"
	"github.com/1layar/merasa/backend/src/product_catalog_service/internal/controller"
	"github.com/1layar/merasa/backend/src/product_catalog_service/internal/infra"
	"github.com/1layar/merasa/backend/src/product_catalog_service/internal/repo"
	"github.com/1layar/merasa/backend/src/product_catalog_service/internal/server"
	"github.com/1layar/merasa/backend/src/product_catalog_service/internal/service"
	"github.com/1layar/merasa/backend/src/product_catalog_service/internal/x/logger"
	"github.com/1layar/merasa/backend/src/product_catalog_service/internal/x/logger/fxlogger"
	"go.uber.org/fx"
)
