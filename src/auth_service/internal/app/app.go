...
import (
	...
	"github.com/1layar/merasa/backend/src/auth_service/internal/app/appcontext"
	"github.com/1layar/merasa/backend/src/auth_service/internal/handler"
	"github.com/1layar/merasa/backend/src/auth_service/internal/infra"
	"github.com/1layar/merasa/backend/src/auth_service/internal/repo"
	"github.com/1layar/merasa/backend/src/auth_service/internal/server"
	"github.com/1layar/merasa/backend/src/auth_service/internal/service"
	"github.com/1layar/merasa/backend/src/auth_service/internal/x/logger"
	"github.com/1layar/merasa/backend/src/auth_service/internal/x/logger/fxlogger"
